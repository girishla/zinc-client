...
export const layoutActions = {
  ...
  animateMenus: createAction(ANIMATE_MENUS, (menuId: number, willCloseMenu: boolean) => ({
    type: ANIMATE_MENUS,
    menuId,
    willCloseMenu,
  })),
  ...
  animateRootMenus: createAction(ANIMATE_ROOT_MENUS, (rootMenuName: string, willCloseRootMenu: boolean) => ({
