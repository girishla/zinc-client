...
export interface ITheme {
  ...
  headerItemBackgroundColor: string;
  headerItemFontWeight: string;
  selectedMenuListItemColor: string;
  selectedMenuListItemBackgroundColor: string;
  selectedListItemColor: string;
  selectedListItemBackgroundColor: string;
  menuItemColor: string;
  avatarSpanColor: string;
  avatarSpanTextShadow: string;
  appBarMenuButtonColor: string;
  settingsOptionsColor: string;
}
...
class Theme {
  public static defaultMainColor: string = "#7144b7";
